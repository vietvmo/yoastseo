...
const CornerstoneSEOAssessor = function (i18n, options) {
	...
	if (process.env.YOAST_RECALIBRATION === "enabled") {
		this._assessments = [new IntroductionKeywordAssessment(), new KeyphraseLengthAssessment(), new KeywordDensityAssessment(), new MetaDescriptionKeywordAssessment(), new MetaDescriptionLength({
			scores: {
				tooLong: 3,
				tooShort: 3
			}
		}), new SubheadingsKeyword(), new TextCompetingLinksAssessment(), new TextImages({
			scores: {
				noImages: 3,
				withAltNonKeyword: 3,
				withAlt: 3,
		...
		}), new TitleKeywordAssessment(), new InternalLinksAssessment(), new TitleWidth({
			scores: {
				widthTooShort: 3,
				widthTooLong: 3
			}
		...
		}), new FunctionWordsInKeyphrase(), new SingleH1Assessment()];
	} else {
		this._assessments = [new IntroductionKeywordAssessment(), new KeyphraseLengthAssessment(), new KeywordDensityAssessment(), new MetaDescriptionKeywordAssessment(), new MetaDescriptionLength({
			scores: {
				tooLong: 3,
		...
		}), new TextCompetingLinksAssessment(), new TextImages({
			scores: {
				noImages: 3,
				withAltNonKeyword: 3,
				withAlt: 3,
		...
		}), urlStopWords, new FunctionWordsInKeyphrase()];
	}
};
