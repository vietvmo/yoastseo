...
const keywordHasStopWordsAssessment = function (paper, researcher, i18n) {
	...
	assessmentResult.setText(i18n.sprintf(stopWordsResult.text, createAnchorOpeningTag("https://yoa.st/34b"), createAnchorOpeningTag("https://yoa.st/34c"), "</a>", stopWords.length));
