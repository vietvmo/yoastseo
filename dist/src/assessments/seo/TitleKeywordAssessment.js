...
class TitleKeywordAssessment extends Assessment {
  ...
  */
   ...
   %3$s expands to the anchor end tag, %4$s expands to the keyword of the article. */
			i18n.dgettext("js-text-analysis", "%1$sKeyphrase in title%3$s: Not all the words from your keyphrase \"%4$s\" appear in the SEO title. " + "%2$sTry to use the exact match of your keyphrase in the SEO title%3$s."), this._config.urlTitle, this._config.urlCallToAction, "</a>", keyword)
		};
	}
}
