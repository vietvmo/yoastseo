...
export default class SubHeadingsKeywordAssessment extends Assessment {
  ...
  */
	hasSubheadings(paper) {
		const subheadings = process.env.YOAST_RECALIBRATION === "enabled" ? getSubheadingsTopLevel(paper.getText()) : getSubheadings(paper.getText());
  ...
  */
	hasGoodNumberOfMatches() {
		return inRangeStartEndInclusive(this._subHeadings.matches, this._minNumberOfSubheadings, this._maxNumberOfSubheadings);
	}
