...
class KeywordDensityAssessment extends Assessment {
  ...
  */
	hasTooFewMatches() {
		return inRangeStartInclusive(this._keywordDensity, 0, this._boundaries.minimum) || this._keywordCount.count === 1;
	}
  ...
  */
	hasGoodNumberOfMatches() {
		return inRangeStartEndInclusive(this._keywordDensity, this._boundaries.minimum, this._boundaries.maximum) || this._keywordCount.count === 2 && this._minRecommendedKeywordCount <= 2;
	}
  ...
  */
	hasTooManyMatches() {
		return inRangeEndInclusive(this._keywordDensity, this._boundaries.maximum, this._boundaries.overMaximum);
	}
