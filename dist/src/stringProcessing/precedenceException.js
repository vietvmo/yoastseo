...
const cannotBeBetweenAuxiliaryAndParticipleFrench = cannotBeBetweenAuxiliaryAndParticipleFrenchFactory().cannotBeBetweenPassiveAuxiliaryAndParticiple;
import cannotBeBetweenAuxiliaryAndParticipleEnglishFactory from "../researches/english/functionWords.js";
const cannotBeBetweenAuxiliaryAndParticipleEnglish = cannotBeBetweenAuxiliaryAndParticipleEnglishFactory().cannotBeBetweenPassiveAuxiliaryAndParticiple;
import cannotBeBetweenAuxiliaryAndParticipleSpanishFactory from "../researches/spanish/functionWords.js";
const cannotBeBetweenAuxiliaryAndParticipleSpanish = cannotBeBetweenAuxiliaryAndParticipleSpanishFactory().cannotBeBetweenPassiveAuxiliaryAndParticiple;
import cannotBeBetweenAuxiliaryAndParticipleItalianFactory from "../researches/italian/functionWords.js";
const cannotBeBetweenAuxiliaryAndParticipleItalian = cannotBeBetweenAuxiliaryAndParticipleItalianFactory().cannotBeBetweenPassiveAuxiliaryAndParticiple;
