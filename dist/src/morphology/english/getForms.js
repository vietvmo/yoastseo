...
export function getForms(word, morphologyData) {
	...
	return unique(flatten([getNounFormsWithPossessives(word, morphologyData.nouns), getVerbForms(word, morphologyData.verbs), getAdjectiveForms(word, morphologyData.adjectives)]));
}
